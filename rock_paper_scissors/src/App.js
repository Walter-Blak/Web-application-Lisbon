...
function App() {
  ...
  const getScores = async () => {
            try {
              const dbResponse = await fetch(`${ip}3001/getScore?minigame=RockPaperScissors,bigger`);
  ...
  const AddScore = async () => {
          try {
            ...
            const res = await fetch(`${ip}3001/addScoreSum?score=${userName},RockPaperScissors,0.5`);
