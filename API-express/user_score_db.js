...
async function add_user_score_bigger(username, minigame, userscore){
        ...
        if (getUser){
            ...
            if (getUser.userName == username && getUser.miniGame == minigame){
                ...
                console.log(`"Second if" with ${score} and userscore is ${userscore}`);
                if (score < userscore){
...
module.exports = {add_user_score_bigger, add_user_score_smaller, getUserScores_fromBigger, getUserScores_fromSmaller}; 